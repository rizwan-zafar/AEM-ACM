 ...
 * you can use relvent method of helper calss
 */
public class SlingServerSideTestsBase extends SlingTestBase {
    ...
    public SlingServerSideTestsBase() {
        ...
        if(!servletOk) {
           static final RetryingContentChecker servletChecker = new RetryingContentChecker(getRequestExecutor(), getRequestBuilder(),
